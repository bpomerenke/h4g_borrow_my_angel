//
//  IssueChoiceCollectionViewController.swift
//  BorrowMyAngel
//
...
class IssueChoiceCollectionViewController: UICollectionViewController {
    ...
    */
    ...
    override func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "issueChoice", for: indexPath)
